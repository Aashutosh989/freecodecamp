...
echo $($PSQL "select name from games inner join teams on games.winner_id=teams.team_id or teams.team_id=games.opponent_id where year=2014 and round='Eighth-Final' order by name;")
